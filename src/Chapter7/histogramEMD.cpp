...
int main(int argc, const char * argv[]) {
    ...
    if (argc == 2 && ((src1 = cvLoadImage(argv[1], 1)) != 0) && ((src2 = cvLoadImage(argv[2], 1)) != 0)) {
        ...
        cvNamedWindow( "H-S Histogram - 1", 1 );
        cvShowImage( "H-S Histogram - 1", hist_img1 );

        cvNamedWindow( "Source - 2", 1 );
        cvShowImage( "Source - 2", src2 );
        cvNamedWindow( "H-S Histogram - 2", 1 );
        cvShowImage( "H-S Histogram - 2", hist_img2 );
